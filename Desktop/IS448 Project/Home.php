...
<body>
<p class = "header">
	<span class = "title">iPark</span>
	<img class = "dogcar" src="https://swe.umbc.edu/~crissey1/448images/car.png" alt="dogcar"/>
...
<div class = "parking">
	<p>
	<span class = "main_textbox">
		<span style="font-size:20pt">Don't forget to get your parking permit</span><br/>
		If you need one contact parking service, because trust me you dont want a ticket.<br/>
		<a style="text-decoration: none;color:gold" href = "http://parking.umbc.edu"> ->Parking Services</a>
	</span>
		<img class = "permit_pic" src="https://swe.umbc.edu/~crissey1/448images/parking_pass.png" alt="Parking Pass"/>
	</p>
</div>
